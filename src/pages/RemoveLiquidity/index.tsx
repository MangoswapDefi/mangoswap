...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@mangoswap-libs/sdk'
...
export default function RemoveLiquidity({
  ...
  async function onAttemptToApprove() {
    ...
    // console.log('---eth_signTypedData_v4   account, data---', account, data)
    library
  ...
  async function onRemove() {
    ...
    // console.log('on remove ', chainId, library, account)
    ...
    // console.log('---ETHER---', ETHER, currencyA, currencyB)
    ...
    // console.log('---methodNames, args---', methodNames, args)
                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            >
                              {TranslateString(1188, 'Receive WOKT')}
                            </StyledInternalLink>
                          ) : oneCurrencyIsWETH ? (
                            <StyledInternalLink
                              to={`/remove/${
                            ...
                            >
                              {TranslateString(1190, 'Receive OKT')}
                            </StyledInternalLink>
                          ) : null}
                        </RowBetween>
                      ) : null}
