import { Currency, ETHER, JSBI, TokenAmount } from '@mangoswap-libs/sdk'
  ...
  const prerequisiteMessage = (
    <LightCard padding="45px 10px">
      <Text style={{ textAlign: 'center' }}>
        {!account
          ? intl('find.connectWalletPools')
          : intl('find.selectTokenInfo')
          }
      </Text>
    </LightCard>
  )
        ...
        <CardBody>
          <AutoColumn gap="md">
            ...
            {hasPosition && (
              ...
              >
                <Text style={{ textAlign: 'center' }}>{intl('find.poolFound')}</Text>
              </ColumnCenter>
            )}
            ...
            {currency0 && currency1 ? (
              pairState === PairState.EXISTS ? (
                ...
                <LightCard padding="45px 10px">
                  <AutoColumn gap="sm" justify="center">
                    <Text style={{ textAlign: 'center' }}>{intl('find.noPoolFound')}</Text>
                    <StyledInternalLink to={`/add/${currencyId(currency0)}/${currencyId(currency1)}`}>
                      {intl('find.createPool')}
                    </StyledInternalLink>
                  </AutoColumn>
                </LightCard>
                ...
                <LightCard padding="45px 10px">
                  <AutoColumn gap="sm" justify="center">
                    <Text style={{ textAlign: 'center' }}>{intl('find.invalidPair')}</Text>
                  </AutoColumn>
                </LightCard>
