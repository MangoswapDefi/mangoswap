...
const useGetPublicIfoData = (ifo: Ifo): PublicIfoData => {
  ...
  // const provider = new ethers.Contract(address, ifoV2Abi, new ethers.providers.JsonRpcProvider('https://exchaintestrpc.okex.org'))
  // provider.startBlock().then(console.log).catch(e => {
  //   console.log('error', e)
  // })
  ...
  const fetchIfoData = useCallback(async () => {
    ...
    console.log('--fetchIfoData-contract---', contract)
