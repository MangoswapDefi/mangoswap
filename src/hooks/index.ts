...
export function useActiveWeb3React2(): Web3ReactContextInterface<Web3Provider> & { chainId?: ChainId } {
...
export const useInterval  = function(callback: () => void, delay: null | number) {
