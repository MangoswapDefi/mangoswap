...
import { JSBI, Pair, Percent } from '@mangoswap-libs/sdk'
      ...
      <AutoColumn gap="12px">
        ...
        {showMore && (
          <AutoColumn gap="8px">
            <FixedHeightRow>
              <RowFixed>
                <Text>{intl({id: 'pool.pooled', data: {symbolName: currency0.symbol}})}:</Text>
              </RowFixed>
              {token0Deposited ? (
                <RowFixed>
            ...
            <FixedHeightRow>
              <RowFixed>
                <Text>{intl({id: 'pool.pooled', data: {symbolName: currency1.symbol}})}:</Text>
              </RowFixed>
              {token1Deposited ? (
                <RowFixed>
            ...
            <FixedHeightRow>
              <Text>{intl('pool.yourPoolTokens')}</Text>
              <Text>{userPoolBalance ? userPoolBalance.toSignificant(4) : '-'}</Text>
            </FixedHeightRow>
            <FixedHeightRow>
              <Text>{intl('pool.yourPoolShare')}</Text>
