...
const theme = (darkMode, color) => ({
  ...
  // primary colors
  primary1: darkMode ? '#2172E5' : baseColors.primary,
...
// eslint-disable-next-line
const TextWrapper = styled(Text)`color: ${({ color, theme }) => theme[color]};`
...
export const TYPE = {
  ...
  Main(props) {
    return <TextWrapper fontWeight={500} fontSize={14} color='primary1' {...props} />
  },
  ...
  pink(props) {
    const {faded} = props
    return <TextWrapper fontWeight={faded ? 400 : 600} color={faded ? 'text1' : 'text1'} {...props} />
  },
};
...
export const GlobalStyle = createGlobalStyle`
  ...
  body {
    ...
    height: 100%;
    font-size: 14px;
    background-color: ${({ _theme }) => _theme.bg6};
  }
