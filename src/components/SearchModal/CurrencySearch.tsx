...
export function CurrencySearch({
  ...
  const filteredTokens: Token[] = useMemo(() => {
    ...
    // return [{ chainId: 65, address: '0xxxxx', decimals: 18, symbol: 'aaa', name: 'xxx', equals: true, sortsBefore: false}]
    ...
    <Column style={{ width: '100%', flex: '1 1' }}>
      <PaddedColumn gap="14px">
        ...
        <SearchInput
          ...
          placeholder={intl('swap.selectTokenPlaceholder')}
          value={searchQuery}
        ...
        <>
          ...
          <Card>
            <RowBetween>
              ...
              >
                {selectedListInfo.current ? intl('swap.change') : intl('swap.selectList')}
              </LinkStyledButton>
            </RowBetween>
          </Card>
        </>
